<div class="bg-gray-800 p-4 rounded-lg relative group">
        ...
        <div class="absolute top-2 right-2 space-x-2 opacity-0 group-hover:opacity-100 transition">
            ...
            <a href="{{route('movie.destroy', $index)}}" onclick="event.preventDefault(); confirm('Are you sure?'); document.getElementById('delete-form-{{$loop->index}}').submit();" class="bg-red-600 p-1 rounded hover:bg-red-500">🗑️</a>
        </div>
    </a>
</div>
